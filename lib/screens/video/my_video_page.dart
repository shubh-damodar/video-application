...
import 'package:video/bloc_patterns/videos/my_videos_bloc.dart';
...
import 'package:video/screens/video/edit_video_page.dart';
...
class _MyVideosPageState extends State<MyVideosPage> {
  ...
  MyVideoBloc _myvideosBloc = MyVideoBloc();
  ...
  void initState() {
    ...
    _myvideosBloc.getReceivedMessages();
  }

  void dispose() {
    super.dispose();
    _myvideosBloc.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: _myvideosBloc.myVideoListStream,
                                                          ...
                                                          child: new Column(
                                                              ...
                                                              children: [
                                                                new Padding(
                                                                  ...
                                                                  child:
                                                                      new Text(
                                                                    asyncSnapshot.data[index].title.length >
                                                                            90
                                              ...
                                              onTap: () {
                                                _navigationActions
                                                  ...
                                                  id: asyncSnapshot
                                                      .data[index].id,
                                                  channelId:
                                                      "${asyncSnapshot.data[index].channelId}",
                                                ));
                                              },
                                            ),
                                          ),
