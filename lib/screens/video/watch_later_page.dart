...
class _WatchLaterPageState extends State<WatchLaterPage> {
  ...
  WatchLater _watchLater = WatchLater();
  ...
  String _jsonMap = "watch-later";

  void initState() {
    _watchLater.getWatchLater(_jsonMap);
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: _watchLater.watchLaterListStream,
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: <
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                      new Text(
                                                                    // "${asyncSnapshot.data[index].duration.toString()}",
