...
class FevouritVideoPage extends StatefulWidget {
  _FevouritVideoPageState createState() => _FevouritVideoPageState();
}

class _FevouritVideoPageState extends State<FevouritVideoPage> {
  ...
  final GlobalKey<ScaffoldState> _fevScaffoldKey =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: _favouritesBloc.favouritesListStream,
