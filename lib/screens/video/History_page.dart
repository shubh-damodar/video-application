...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void initState() {
    ...
    _historyBloc.getWatchHistory(_jsonMap);
  }
  ...
  Future<bool> _deleteAllVideo() {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
                title: Text('Are you sure?'),
                content: Text('Do you want to remove from history'),
                actions: <Widget>[
                  FlatButton(
  ...
  Future<bool> _removeVideo(String id) {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              FlatButton(
                onPressed: () {
                  _historyBloc.deleteAllHistoryVideo(id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        actions: <Widget>[
          StreamBuilder(
              stream: _historyBloc.historyListStream,
              builder: (BuildContext context,
      ...
      body: StreamBuilder(
          ...
          builder: (BuildContext context,
            ...
            return new Column(
              children: <Widget>[
                StreamBuilder(
                  stream: _historyBloc.composeFinishedStream,
                  builder: (BuildContext context,
